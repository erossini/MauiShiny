...
public static class MauiProgram
{
    public static MauiApp CreateMauiApp()
    {
        ...
        builder.Services.AddPushAzureNotificationHubs<MyPushDelegate>(
            "Endpoint=sb://languageinuse.servicebus.windows.net/;SharedAccessKeyName=DefaultListenSharedAccessSignature;SharedAccessKey=XfPbpiz2EGlsjsjAqEmFUoZJqNV+UM8qt9sl8K+15fU=",
            "app"
